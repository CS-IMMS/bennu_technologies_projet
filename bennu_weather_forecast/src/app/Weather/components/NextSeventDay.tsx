        ...
        <>
            <div className="w-100">
                <div className={`flex text-center pt-3 ${isNight ? 'text-swatch1' : 'text-black'}`}>
                    ...
                    <Image priority alt="menu icon" className="pt-2 pl-5 cursor-pointer text-swatch1" src="/icons/menu.svg" width={60} height={60} />
                    {/* <MenuIcon /> */}
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex relative">
                                                ...
                                                <div className="h-2 max-w-[100px] mb-4 text-xs text-center relative flex rounded gap-0" style={{ zIndex: '2' }}>
                                                    ...
                                                    <div style={{ width: `30px` }} className="shadow-none py-3 ml-5 rounded-l-xl flex flex-col text-center whitespace-nowrap text-white justify-center bg-swatch5"></div>
                                                    <div style={{ width: `${day.averageTemperature < day.maxTemperature ? day.averageTemperature +20 : "30"}px` }} className="shadow-none py-3 rounded-r-xl flex flex-col text-center whitespace-nowrap text-white justify-start bg-swatch7"></div>
                                                </div>
